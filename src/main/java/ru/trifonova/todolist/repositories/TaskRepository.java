...
public class TaskRepository {
    ...
    public void save(Task task){
        jdbcTemplate.update(saveTaskSql, task.getTitle(), task.getDescription(), task.getCreateAt(),
    ...
    public void update(Task task){
        jdbcTemplate.update(updateTaskSql, task.getTitle(), task.getDescription(), task.getCreateAt(),
